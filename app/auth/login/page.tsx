    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md animate-fade-in">
        <div className="text-center mb-8">
          ...
          <p className="text-text-muted">Sign in to your NutriTrack account</p>
        </div>
        ...
        <Card className="bg-gradient-card border border-border/50 shadow-dark-lg">
          <CardContent className="p-8 space-y-6">
            ...
            <form onSubmit={handleEmailLogin} className="space-y-4">
              ...
              {message && (
                <div className="text-sm text-red-400 bg-red-500/10 border border-red-500/20 p-4 rounded-2xl animate-fade-in">
                  {message}
                </div>
              )}
