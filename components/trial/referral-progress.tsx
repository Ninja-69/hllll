    ...
    <Card className="border-green-200 bg-green-50">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex gap-2">
          <Button onClick={handleShareLink} className="flex-1 bg-green-600 text-white hover:bg-green-700 text-base py-3">
            📱 Share Link
          </Button>
          <Button
            variant="outline"
            className="flex-1 border-green-300 text-green-900 hover:bg-green-100 bg-transparent text-base py-3"
            onClick={handleCopyLink}
          >
        ...
        <div className="grid grid-cols-3 gap-2 pt-2">
          <Button
            variant="outline"
            size="sm"
            onClick={() => window.open(`https://wa.me/?text=${encodeURIComponent(`Hey! I've been using NutriTrack to track my nutrition and it's amazing! Join me and get 3 extra days free: ${referralLink}`)}`)}
          ...
          <Button
            variant="outline"
            size="sm"
            onClick={() => window.open(`mailto:?subject=Join me on NutriTrack&body=${encodeURIComponent(`Hey! I've been using NutriTrack to track my nutrition and it's amazing! Join me and get 3 extra days free: ${referralLink}`)}`)}
          ...
          <Button
            variant="outline"
            size="sm"
            onClick={() => window.open(`https://twitter.com/intent/tweet?text=${encodeURIComponent(`I've been using NutriTrack to track my nutrition and it's amazing! Join me: ${referralLink}`)}`)}
