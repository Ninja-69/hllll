  ...
  return (
    <div className="min-h-screen bg-background pb-24 md:pb-8">
      ...
      <main className="max-w-4xl mx-auto px-4 py-6 md:px-6 space-y-8">
        ...
        {/* Invite Friends CTA */}
        <section className="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl p-6 text-white shadow-lg">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <h3 className="text-lg font-bold mb-2">🎁 Invite Friends & Get Pro Free!</h3>
              <p className="text-blue-100 text-sm mb-3">
                Invite 3 friends and unlock 30 days of Pro access. They get 3 extra days too!
              </p>
              <div className="flex items-center gap-2 text-blue-100 text-xs">
                <span className="bg-blue-400 px-2 py-1 rounded-full text-white font-medium">
